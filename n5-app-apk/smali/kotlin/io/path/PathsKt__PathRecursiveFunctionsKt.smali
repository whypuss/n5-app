...
.method public static final copyToRecursively(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZLkotlin/jvm/functions/Function3;)Ljava/nio/file/Path;
    ...
    .line 531
    .local v7, "it":Ljava/nio/file/Path;
    const/4 v8, 0x0

    .line 188
    .local v8, "$i$a$-let-PathsKt__PathRecursiveFunctionsKt$copyToRecursively$isSubdirectory$1":I
    new-array v9, v1, [Ljava/nio/file/LinkOption;
    ...
    invoke-static {v7, v9}, Ljava/nio/file/Files;->exists(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-interface {v7, v9}, Ljava/nio/file/Path;->toRealPath([Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v9

    new-array v10, v1, [Ljava/nio/file/LinkOption;

    invoke-interface {p0, v10}, Ljava/nio/file/Path;->toRealPath([Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v10

    invoke-interface {v9, v10}, Ljava/nio/file/Path;->startsWith(Ljava/nio/file/Path;)Z
    ...
    .line 182
    .end local v7    # "it":Ljava/nio/file/Path;
    .end local v8    # "$i$a$-let-PathsKt__PathRecursiveFunctionsKt$copyToRecursively$isSubdirectory$1":I
    :cond_5
    :goto_1
    nop
    ...
    .line 191
    const-string v9, "Recursively copying a directory into its subdirectory is prohibited."

    invoke-direct {v5, v7, v8, v9}, Ljava/nio/file/FileSystemException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .local v7, "stack":Ljava/util/ArrayList;
    move-object v3, v0
    ...
    .end local v7    # "stack":Ljava/util/ArrayList;
    :cond_8
